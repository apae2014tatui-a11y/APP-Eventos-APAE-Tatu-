...
const initialEvents: Event[] = [
  {
    id: 'evt-1',
    name: 'Evento Beneficente APAE',
    date: '2024-12-20T19:00:00',
    ticketTypes: [
      { id: 'tt-1', name: 'Individual', price: 50 },
      { id: 'tt-2', name: 'Mesa Familiar', price: 200 },
    ],
  },
];
...
const App: React.FC = () => {
  ...
  const deleteEvent = (eventId: string) => {
    if (confirm("Deseja realmente excluir este evento e todos os seus registros?")) {
